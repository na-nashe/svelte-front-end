...
<section
	class="relative overflow-hidden rounded-b-[36px] bg-[#1c1917] px-4 pt-24 pb-6 sm:pt-32 sm:pb-10"
>
	<!-- Dot grid pattern -->
	<div
	...
	<div class="relative z-10 mx-auto max-w-6xl">
		...
		<div class="mb-10 grid items-center gap-10 lg:grid-cols-2">
			...
			<div>
				<!-- Badge -->
				<div
					class="mb-5 inline-flex animate-up items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 backdrop-blur-sm"
				>
				...
				<p
					class="max-w-md animate-up font-[Outfit] text-base text-stone-400"
			...
			>
				{#each stats as stat (stat.label)}
					<div
						class="flex min-w-[140px] flex-col items-center rounded-2xl border border-white/10 bg-white/5 px-6 py-5 backdrop-blur-sm"
					>
